...
\begin{abstract}
    We outline a plan of formalization for Kripke frames, define the modal operators $\square$, $\diamond$ and characterise some of the most relevant modal logic axioms, Boolean algebra structure, semantic soundness. Time permitting, we will formalize some examples.
  \end{abstract}
